...
x1 = makeUncheckedTgraph
      [LK (1,8,3),RD (2,3,8),RK (1,3,9),LD (4,9,3),LK (5,10,13)
      ,RD (6,13,10),LK (3,2,13),LD (6,11,13),LK (7,4,14),RK (7,14,12)
      ]

-- x2 is not connected
x2 = makeUncheckedTgraph (faces x1 ++ [LK (15,16,17),RK (15,17,18)])

-- x3 has edge conflicts 
x3 = makeUncheckedTgraph
       [LK (3,8,1),RD (2,3,8),RK (1,3,9),LD (4,9,3),LK (5,10,13)
       ,RD (6,13,10),LK (3,2,13),LD (6,11,13),LK (7,4,14),RK (7,14,12)
       ]
