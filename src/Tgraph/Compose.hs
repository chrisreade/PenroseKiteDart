...
-- |partkCompose is an experimental and unsafe composer only used by composeK.
...
-- | Auxilliary function for partCompose.
-- Creates a list of new composed faces together with a list of grouped old faces of the argument graph.
