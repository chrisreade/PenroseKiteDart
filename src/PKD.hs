...
Description : The main module which re-exports TileLib and all the Tgraph modules
              plus additional Tgraph functions
Copyright   : (c) Chris Reade, 2024
License     : BSD-style
Maintainer  : chrisreade@mac.com
Stability   : experimental

This is the main module which re-exports TileLib and all the Tgraph modules
(Tgraph.Prelude, Tgraph.Decompose, Tgraph.Compose, Tgraph.Force, Tgraph.Relabelling).
It defines several functions for producing overlaid diagrams for Tgraphs
(including smart drawing) and experimental combinations such as
